...
// Qt version >= 6.8.0: Q_NAMESPACE in a non-class namespace generates incompatible MOC code — skip
#if QT_VERSION >= 0x060200 && QT_VERSION < 0x060800 // don't use QT_VERSION_CHECK here, some moc versions don't understand it
namespace QCP {
  Q_NAMESPACE // this is how to add the staticMetaObject to namespaces in newer Qt versions
#elif QT_VERSION >= 0x060800
namespace QCP {
...
// Qt >= 6.8.0: Q_NAMESPACE is skipped above, so Q_ENUM_NS/Q_FLAG_NS must also be skipped
#if QT_VERSION >= 0x060200 && QT_VERSION < 0x060800
Q_ENUM_NS(ExportPen)
